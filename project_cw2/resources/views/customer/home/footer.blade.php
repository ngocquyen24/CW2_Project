    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/" class="stext-107 cl7 hov-cl1 trans-04">
                            Trang Chủ
                        </a>
                    </li>
                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/1-banh.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Bánh
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/2-nuoc-uong.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Nước Uống
                        </a>
                    </li>
